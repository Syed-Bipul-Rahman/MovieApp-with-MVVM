...
import com.learning.movieapp_mvvm.databinding.MovieRowBinding;
...
//
//        String imageUrl = "https://image.tmdb.org/t/p/original" +result.getPosterPath();
//        Picasso.get().load(imageUrl).into(holder.movieRowBinding.avatar);
